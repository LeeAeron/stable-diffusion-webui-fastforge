...
def on_preset_change(preset=None):
    ...
    if shared.opts.forge_preset == 'xl':
        ...
        return [
            ...
            gr.update(visible=False, value=3.5),                                        # ui_txt2img_distilled_cfg
            gr.update(visible=False, value=3.5),                                        # ui_img2img_distilled_cfg
            gr.update(value=getattr(shared.opts, "xl_t2i_sampler", 'DPM++ 2M SDE')),         # ui_txt2img_sampler
            gr.update(value=getattr(shared.opts, "xl_i2i_sampler", 'DPM++ 2M SDE')),         # ui_img2img_sampler
            gr.update(value=getattr(shared.opts, "xl_t2i_scheduler", 'Karras')),     # ui_txt2img_scheduler
...
shared.options_templates.update(shared.options_section(('ui_flux', "UI defaults 'flux'", "ui"), {
    ...
    "flux_i2i_width":    shared.OptionInfo(1152, "img2img width",                gr.Slider, {"minimum": 64, "maximum": 2048, "step": 8}),
